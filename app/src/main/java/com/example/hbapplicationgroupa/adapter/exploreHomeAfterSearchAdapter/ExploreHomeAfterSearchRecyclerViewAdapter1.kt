...
class ExploreHomeAfterSearchRecyclerViewAdapter1(
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val hotelName1 = itemView.findViewById<TextView>(R.id.exploreHomeAfterSearchFragmentRecyclerViewTextviewName1)
        val hotelPrice1 = itemView.findViewById<TextView>(R.id.exploreHomeAfterSearchFragmentRecyclerViewTextviewPrice1)
        val hotelImage1 = itemView.findViewById<ImageView>(R.id.exploreHomeAfterSearchFragmentRecyclerViewImageview1)
    }
