...
class HotelRoomDaoByIdRepository @Inject constructor(val hbAuthenticationModule: HBAuthenticationModuleApi, val hotelRoomByIdDao: HotelRoomByIdDao): HotelRoomByIdRepositoryInterface{
