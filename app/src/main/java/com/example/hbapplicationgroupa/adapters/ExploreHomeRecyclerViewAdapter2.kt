...
class ExploreHomeRecyclerViewAdapter2(
    var listOfHotels : List<Hotel>
) : RecyclerView.Adapter<ExploreHomeRecyclerViewAdapter2.Recycler1ViewHolder>() {

    inner class Recycler1ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        val hotelName = itemView.findViewById<TextView>(R.id.exploreHomeFragmentRecyclerViewTextviewName2)
        val hotelPrice = itemView.findViewById<TextView>(R.id.exploreHomeFragmentRecyclerViewTextviewPrice2)
        val hotelImage = itemView.findViewById<ImageView>(R.id.exploreHomeFragmentRecyclerViewImageview2)
